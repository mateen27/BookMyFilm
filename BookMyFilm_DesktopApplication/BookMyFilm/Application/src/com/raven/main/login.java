     ...
     public void actionPerformed(ActionEvent e){
        if(e.getSource() == jButton1){
            try
            {
				...
				String query = "select * from adminlogin where AdminID = '"+Username+"' and AdminPassword = '"+Password+"'";
				try {
					...
					if(rs.next()) {
						...
						JOptionPane.showMessageDialog(null, "The Entered ADMIN ID or Password is wrong!");
					}
				}
				catch(Exception ex) {
